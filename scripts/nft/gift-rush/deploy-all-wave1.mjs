/**
 * Deploy Rush Wave 1 for all rarities, then write public/rush-cm.json.
 *
...
import { RUSH_TREASURY, GIFT2U_ELVES_COLLECTION } from "./config.mjs";
...
for (const rarity of RARITIES) {
  ...
  out[rarity] = {
    ...
    imageUri: r.imageUri,
    itemUri: r.itemUri,
    treasury: r.treasury || RUSH_TREASURY,
  };
}

const pubPath = path.join(ROOT, "public/rush-cm.json");
