/**
 * Deploy Shadow Wave 1 for all rarities, then write public/shadow-cm.json.
 *
...
import { SHADOW_TREASURY, GIFT2U_ELVES_COLLECTION } from "./config.mjs";
...
for (const rarity of RARITIES) {
  ...
  out[rarity] = {
    ...
    imageUri: r.imageUri,
    itemUri: r.itemUri,
    treasury: r.treasury || SHADOW_TREASURY,
  };
}

const pubPath = path.join(ROOT, "public/shadow-cm.json");
