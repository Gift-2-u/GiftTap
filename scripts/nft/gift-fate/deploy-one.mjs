/**
 * Deploy one Fate Wave 1 CM + Guard + Wrap with priority fees.
...
console.log("=== Fate", r.label, "Wave 1 ===");
...
if (!fs.existsSync(imagePath)) imagePath = path.join(__dirname, "Fate.jpg");
