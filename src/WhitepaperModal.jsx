...
const WhitepaperModal = ({ isWhitepaperOpen, setIsWhitepaperOpen }) => {
  ...
  const PLAYBOOK = [
    ...
    {
      id: 4,
      title: "4. NFT Classes (The Elves)",
      content: "To master the game economy, you must utilize the four classes of Elves: \n\n• Data Architect: Increases passive Shard generation.\n• Solar Power Forger: Expands your Energy Cap.\n• Urban Power Basher: Multiplies Shards earned per tap.\n• Cryptic Fate Giver: Boosts luck and late-game $GFT conversion rates."
    },
    {
      id: 5,
