...
const WhitepaperModal = ({ isWhitepaperOpen, setIsWhitepaperOpen, onClose }) => {
  ...
  const PLAYBOOK = [
    ...
    },
    {
      ...
      content: "Gift Tap does not rely on a randomized airdrop. Instead, the GFTshards you extract and accumulate in-game are intended to be swappable for official on-chain $GFT tokens following a token launch, if and when it occurs.\n\nIMPORTANT — NOT AN INVESTMENT:\n• $GFT (and GFTshards) are not investment products. Nothing in Gift Tap is a promise of profit, yield, or price appreciation.\n• Cryptocurrency prices are highly volatile. Gift2u / Gift Tap and its operators are NOT responsible for any change in the price of $GFT, SOL, NFTs, or any other asset, including total loss of value.\n• You alone decide whether to buy, hold, or sell any token. This is not financial advice.\n\nYour Web3 Wallet:\nUpon joining on the web app, a secure Solana wallet is generated for you. Purchases and fees are paid from this in-app wallet (with a platform fee to the Gift Tap treasury). You fully own the keys — Gift Tap does not keep your seed.\n\nSecurity Reminder: Save your 12-word Secret Phrase during onboarding and in the Menu. It is the only way to restore your account on a new device. Never share it with anyone.\n\nComing from Telegram? Use Restore on the invite screen with your 12-word phrase to load your existing progress.\n\nSee also Terms of Use in the Menu for full legal disclaimers."
    },
    {
      id: 7,
