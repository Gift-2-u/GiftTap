/**
 * Public Terms of Use & Privacy Policy for Gift2u / Gift Tap.
 * Used by LegalModal and /terms + /privacy pages.
 */
...
3. G2U, G2Ushards, and digital assets — important risk disclaimer
• G2Ushards are in-game / app-tracked points used inside Gift Tap. They are not money, not a bank deposit, and not a guarantee of any future value.
• G2U credit on your account (from Shard Swap) is an in-app balance until/unless converted to an on-chain $G2U token under rules we publish. It is not a bank deposit.
• The $G2U token (if and when fully launched on-chain) is a digital asset on a public blockchain. Cryptocurrency and tokens are highly volatile and speculative.
• $G2U AND G2USHARDS ARE NOT INVESTMENT PRODUCTS. We do not promise profits, yield, price appreciation, liquidity, or any return. Any internal design values (e.g. illustrative shard value) are not market guarantees.
• You alone are responsible for any decision to acquire, hold, trade, or sell $G2U, SOL, NFTs, or any other asset.
• WE ARE NOT RESPONSIBLE FOR PRICE CHANGES of $G2U, SOL, NFTs, or any other asset, including total loss of value.
...
• Free players may earn G2Ushards by tapping at any unlocked level without paying a wall fee. Ascension walls are optional upgrades for higher multipliers and tiers — not a closed gate to earning.
...
3B. Shard Swap
• Shard Swap converts G2Ushards into G2U (credit and/or token under then-current rules). Platform fees may apply in G2U after conversion. Daily caps and minimums may apply.
...
6. Retention
We keep account and game data while your account exists and as needed for security, disputes, and legal obligations. You can delete your Gift Tap account in Settings → Delete my account (password + username confirmation), or follow the steps at https://gift2u.fun/delete-account. That removes your profile, login, and in-app progress from our servers. On-chain SOL, $G2U, and NFTs in your Solana wallet cannot be deleted by us.
