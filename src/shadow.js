...
export const SHADOW_WAVE1 = {
  common: {
    ...
    maxSupply: 17500,
    border: '#C0C0C0',
    imageUrl: '/nft/shadow/Shadow-common.jpg?v=1',
    imageUri: 'https://gateway.irys.xyz/F4wILInf0lOKYAWXW3fRGFqisQCMm_DIe17coBc7teU',
    feeBufferSol: 0.02,
    maxPerWallet: 5,
  },
  rare: {
    ...
    maxSupply: 5250,
    border: '#3B82F6',
    imageUrl: '/nft/shadow/Shadow-rare.jpg?v=1',
    imageUri: 'https://gateway.irys.xyz/iz8Aia5cvMETbJpAsC6u75k8EhqEiAvbZCKeCqse4Bk',
    feeBufferSol: 0.02,
    maxPerWallet: 5,
  },
  epic: {
    ...
    maxSupply: 1750,
    border: '#A855F7',
    imageUrl: '/nft/shadow/Shadow-epic.jpg?v=1',
    imageUri: 'https://gateway.irys.xyz/WDn9RrVEIjWY-Kukdzka6N6_2dE8u-7WC9LvkLcr1gU',
    feeBufferSol: 0.02,
    maxPerWallet: 5,
  },
  legendary: {
    ...
    maxSupply: 500,
    border: '#EAB308',
    imageUrl: '/nft/shadow/Shadow-legendary.jpg?v=1',
    imageUri: 'https://gateway.irys.xyz/TsgNtEBbOIHB8ZccT5R9boDqHV3CE2_WIM6q7rLSfYE',
    feeBufferSol: 0.02,
    maxPerWallet: 5,
  },
};
